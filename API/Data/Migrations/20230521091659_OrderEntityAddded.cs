...
{
    public partial class OrderEntityAddded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BuyerId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingAddress_ProductId = table.Column<int>(type: "int", nullable: false),
                    ShippingAddress_Name = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShippingAddress_PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "7d9809d9-7242-4c03-a48f-3025a21614d9", "Member", "MEMBER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, "df74ea62-beb0-4e7f-8775-14e33e8b57ff", "Admin", "ADMIN" });
